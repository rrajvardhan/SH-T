...
FontManager::~FontManager()
{
  ...
  {
    TTF_Quit();
    LOG_INFO("[FontManager] SDL_ttf shut down.");
  }
}

TTF_Font*
FontManager::loadFont(const std::string& path, int size)
{
...
TTF_Font*
FontManager::getFont(const std::string& id)
{
...
void
FontManager::drawText(const std::string& fontId,
...
void
FontManager::unloadFont(const std::string& id)
{
  auto it = _fonts.find(id);
  if (it != _fonts.end())
  {
...
bool
FontManager::hasFont(const std::string& id) const
{
