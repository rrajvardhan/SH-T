...
bool
Graphics::init(const RendererConfig& config)
{
  ...
  _window = SDL_CreateWindow(
      config.title, config.x, config.y, config.width, config.height, config.windowFlags);
...
void
Graphics::drawFilledRect(int x, int y, int w, int h, SDL_Color color)
{
...
void
Graphics::drawRectOutline(int x, int y, int w, int h, SDL_Color color)
{
  SDL_SetRenderDrawColor(_renderer, color.r, color.g, color.b, color.a);
  SDL_Rect rect = { x, y, w, h };
...
void
Graphics::drawLine(int x1, int y1, int x2, int y2, SDL_Color color)
{
  SDL_SetRenderDrawColor(_renderer, color.r, color.g, color.b, color.a);
...
void
Graphics::drawPoint(int x, int y, SDL_Color color)
{
  SDL_SetRenderDrawColor(_renderer, color.r, color.g, color.b, color.a);
...
void
Graphics::drawCircle(int cx, int cy, int radius, SDL_Color color)
{
  SDL_SetRenderDrawColor(_renderer, color.r, color.g, color.b, color.a);
...
void
Graphics::drawFilledCircle(int cx, int cy, int radius, SDL_Color color)
{
