          ...
          if (elapsed > 400)
          {
            ...
            if (mOverwrite && cindex < (int) line.size())
            {
              ...
              else
              {
                ...
                buf2[1] = '\0';
                width
                    = ImGui::GetFont()->CalcTextSizeA(ImGui::GetFontSize(), FLT_MAX, -1.0f, buf2).x;
              }
            }
    ...
    for (auto first = bufferBegin; first != last;)
    {
      ...
      else
      {
        ...
        if (token_color == PaletteIndex::Identifier)
        {
          ...
          // todo : allmost all language definitions use lower case to specify keywords, so
          // shouldn't this use ::tolower ?
          ...
          else
          {
                          ...
                          pred))
            {
              withinSingleLineComment = true;
                     ...
                     && equals(
                         startStr.begin(), startStr.end(), from, from + startStr.size(), pred))
            {
              commentStartLine  = currentLine;
