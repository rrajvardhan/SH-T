...
ImGui::ShowDemoWindow(bool* p_open)
{
  ...
  } // Important: Process the Docking app first, as explicit DockSpace() nodes needs to be submitted
  ...
  if (ImGui::CollapsingHeader("Configuration"))
  {
    ...
    if (ImGui::TreeNode("Configuration##2"))
    {
      ...
      ImGui::SameLine();
      HelpMarker("Using directional navigation key makes the cursor visible. Mouse click hides the "
                 "cursor.");
      ...
      if (io.ConfigFlags & ImGuiConfigFlags_DockingEnable)
      {
        ...
        ImGui::SameLine();
        HelpMarker("Make window or viewport transparent when docking and only display docking "
      ...
      // ImGui::SameLine(); HelpMarker("Experimental: Automatically update style.FontScaleDpi when
      // Monitor DPI changes. This will scale fonts but NOT style sizes/padding for now.");
      // ImGui::Checkbox("io.ConfigDpiScaleViewports", &io.ConfigDpiScaleViewports);
      // ImGui::SameLine(); HelpMarker("Experimental: Scale Dear ImGui and Platform Windows when
      // Monitor DPI changes.");
      ...
      HelpMarker("First calls to Begin()/BeginChild() will return false.\n\nTHIS OPTION IS "
                 "DISABLED because it needs to be set at application boot-time to make sense. "
                 "Showing the disabled option is a way to make this feature easier to discover.");
...
DemoWindowWidgetsComboBoxes()
{
  ...
  if (ImGui::TreeNode("Combo"))
  {
    ...
    HelpMarker("The Combo() function is not greatly useful apart from cases were you want to embed "
...
// hence the /2.
    ...
    ImGui::SameLine();
    HelpMarker("As with every widget in dear imgui, we never modify values unless there is a user "
               "interaction.\n"
    ...
    ImGui::SliderScalar(
        "slider u64 reverse", ImGuiDataType_U64, &u64_v, &u64_fifty, &u64_zero, "%" PRIu64 " ms");
    ...
    ImGui::InputScalar(
        "input s16", ImGuiDataType_S16, &s16_v, inputs_step ? &s16_one : NULL, NULL, "%d", flags);
    ImGui::InputScalar(
        "input u16", ImGuiDataType_U16, &u16_v, inputs_step ? &u16_one : NULL, NULL, "%u", flags);
    ImGui::InputScalar(
        "input s32", ImGuiDataType_S32, &s32_v, inputs_step ? &s32_one : NULL, NULL, "%d", flags);
    ImGui::InputScalar("input s32 hex",
                       ...
                       flags);
    ImGui::InputScalar(
        "input u32", ImGuiDataType_U32, &u32_v, inputs_step ? &u32_one : NULL, NULL, "%u", flags);
...
DemoWindowWidgetsQueryingStatuses()
{
  ...
  if (ImGui::TreeNode("Querying Item Status (Edited/Active/Hovered etc.)"))
  {
    ...
    HelpMarker("Testing how various types of items are interacting with the IsItemXXX functions. "
               "Note that the bool return value of most ImGui function is generally equivalent to "
  ...
  if (ImGui::TreeNode("Querying Window Status (Focused/Hovered etc.)"))
  {
    ...
    // of a window. This will also work when docked into a Tab (the Tab replace the Title Bar and
    ...
    if (test_window)
    {
      ...
      // feedback loop and get them stuck. Could we fix this through an ImGuiWindowClass feature? Or
      // an API call to tag our parent as "don't skip items"?
...
struct ExampleSelectionWithDeletion : ImGuiSelectionBasicStorage
{
  ...
  int ApplyDeletionPreLoop(ImGuiMultiSelectIO* ms_io, int items_count)
  {
    ...
    {
      ms_io->RangeSrcReset = true; // Request to recover RangeSrc from NavId next frame. Would be ok
  ...
  if (ImGui::TreeNode("Text"))
  {
    ...
    if (ImGui::TreeNode("Word Wrapping"))
    {
      ...
      ImGui::TextWrapped("This text should automatically wrap on the edge of the window. The "
                         ...
                         "for text wrapping follows simple rules suitable for English and possibly "
                         "other languages.");
      ImGui::Spacing();
  ...
  if (ImGui::TreeNode("Text Input"))
  {
    ...
    if (ImGui::TreeNode("Multi-line Text Input"))
    {
      ...
      HelpMarker("You can use the ImGuiInputTextFlags_CallbackResize facility if you need to wire "
                 ...
                 "an example. (This is not demonstrated in imgui_demo.cpp because we don't want to "
...
DemoWindowWidgetsTreeNodes()
{
  ...
  if (ImGui::TreeNode("Tree Nodes"))
  {
    ...
    if (ImGui::TreeNode("Advanced, with Selectable nodes"))
    {
      ...
      ImGui::CheckboxFlags(
          "ImGuiTreeNodeFlags_SpanLabelWidth", &base_flags, ImGuiTreeNodeFlags_SpanLabelWidth);
      ImGui::SameLine();
      HelpMarker("Reduce hit area to the text label and a bit of margin.");
      ImGui::CheckboxFlags(
          "ImGuiTreeNodeFlags_SpanAllColumns", &base_flags, ImGuiTreeNodeFlags_SpanAllColumns);
      ImGui::SameLine();
...
DemoWindowTables()
{
  ...
  if (ImGui::TreeNode("Basic"))
  {
    ...
    HelpMarker("Only using TableNextColumn(), which tends to be convenient for tables where every "
               "cell contains "
  ...
  if (ImGui::TreeNode("Outer size"))
  {
    ...
    ImGui::SameLine();
    HelpMarker("Make outer height stop exactly at outer_size.y (prevent auto-extending table past "
  ...
  if (ImGui::TreeNode("Background color"))
  {
    ...
    ImGui::CheckboxFlags("ImGuiTableFlags_RowBg", &flags, ImGuiTableFlags_RowBg);
    ImGui::SameLine();
    HelpMarker("ImGuiTableFlags_RowBg automatically sets RowBg0 to alternative colors pulled from "
               "the Style.");
...
DemoWindowInputs()
{
  ...
  if (ImGui::CollapsingHeader("Inputs & Focus"))
  {
    ...
    HelpMarker("The value of io.WantCaptureMouse and io.WantCaptureKeyboard are normally set by "
               ...
               "true, it means "
               "Dear ImGui wants the corresponding inputs and we expect the underlying application "
               "to ignore them.\n\n"
  ...
  if (BeginTabBar("##tabs", ImGuiTabBarFlags_None))
  {
    if (BeginTabItem("Sizes"))
    {
      ...
      HelpMarker("Apply to every windows, menus, popups, tooltips: amount where we avoid "
                 "displaying contents. Adjust if you cannot see the edges of your screen (e.g. on "
...
ShowExampleAppDockSpace(bool* p_open)
{
  ...
  if (ImGui::BeginMenuBar())
  {
    if (ImGui::BeginMenu("Options"))
    {
      ...
      if (ImGui::MenuItem(
              "Flag: NoUndocking", "", (dockspace_flags & ImGuiDockNodeFlags_NoUndocking) != 0))
      {
...
ShowExampleAppDocuments(bool* p_open)
{
  ...
  // window ("Example: Documents"). This would create a problematic feedback loop because selecting
  // the "Eggplant" tab would make the "Example: Documents" tab not visible, which in turn would
  // stop submitting the "Eggplant" window. We avoid this problem by submitting our documents window
  // even if our parent window is not currently visible. Another solution may be to make the
  // "Example: Documents" window use the ImGuiWindowFlags_NoDocking.
